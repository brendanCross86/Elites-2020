...
USER_MAP_2016 = '/home/crossb/packaged_ci/maps/user_map_2016.pkl'
USER_MAP_2020 = '/home/crossb/packaged_ci/maps/user_map_2020.pkl'
...
RT_GRAPHS_DIR_2020 = '/home/crossb/packaged_ci/graphs/2020/'
...
PATH_TO_BIAS_2020 = {
    ...
    os.path.join(RT_GRAPHS_DIR_2020, 'extreme_bias_left_2020_ci.gt'): 'left extreme',
    os.path.join(RT_GRAPHS_DIR_2020, 'extreme_bias_right_2020_ci.gt'): 'right extreme',
    os.path.join(RT_GRAPHS_DIR_2020, 'fake_2020_ci.gt'): 'fake',
    os.path.join(RT_GRAPHS_DIR_2020, 'lean_left_2020_ci.gt'): 'left leaning',
    os.path.join(RT_GRAPHS_DIR_2020, 'lean_right_2020_ci.gt'): 'right leaning',
...
def main():
    ...
    # get the top influencers in 2016 and in 2020, by bias type
    top_n_influencers = 30
    top_n_2016_by_bias = top_influencers(top_n_influencers, graphs_2016)
    top_n_2020_by_bias = top_influencers(top_n_influencers, graphs_2020)

    # get the change in influence, per bias for each user
    delta_df = influence_gain(graphs_2016, graphs_2020, N=25, plot=True)
