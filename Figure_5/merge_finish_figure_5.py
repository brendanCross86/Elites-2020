...
def create_user_to_media_type():
    ...
    user_to_fig_text = infl_affiliation
    infl_name_to_affiliation = infl_affiliation_no_handle
    user_to_affiliation = {}
...
def gen_rank_legend(year='2016', minx=0, miny=0):
    ...
    for bias in biases:
        ...
        for rank, (user_id, username) in sorted(top5s[bias].items(), key=lambda x: x[0]):
            ...
            if user_id in user_to_anonymized_label:
                anonymized_text = user_to_anonymized_label[user_id]
